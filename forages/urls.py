...
from .views import HomePageView, ProjectListView, ProjectUpdateView, ProjectDetailView, ProjectDeleteView, ProjectCreateView, EntryCreateView, EntryDeleteView, EntryUpdateView, EntryDetailView
from . import views
urlpatterns = [ 
