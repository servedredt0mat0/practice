...
from .views import HomePageView, ProjectListView, ProjectUpdateView, ProjectDetailView, ProjectDeleteView, ProjectCreateView, EntryCreateView, EntryDeleteView, EntryUpdateView
